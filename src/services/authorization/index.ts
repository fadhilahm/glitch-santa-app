    ...
    private async fetchUserData(): Promise<void> {
      try {
        const [usersResponse, profilesResponse] = await Promise.all([
          fetch('https://raw.githubusercontent.com/alj-devops/santa-data/master/users.json'),
          fetch('https://raw.githubusercontent.com/alj-devops/santa-data/master/userProfiles.json')
        ]);
